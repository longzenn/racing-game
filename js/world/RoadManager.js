/**
 * Infinite Scrolling Multi-Lane Road & Overhead Arches
...
class RoadManager {
  ...
  initRoad() {
    ...
    // High contrast dashed line: Thick white bar on top of dark shadow bar
    ...
    for (let r of this.lineRows) {
      for (let z = 20; z > -this.totalRoadLength + 20; z -= 14) {
        ...
        // Dark outline for contrast on bright surfaces
